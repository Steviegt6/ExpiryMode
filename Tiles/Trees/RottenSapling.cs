...
{
	public class RottenSapling : ModTile
	{
		public override void SetDefaults()
		{
			...
			TileObjectData.newTile.AnchorValidTiles = new[] { TileType<Tiles.DoomGravel>() };
            ...
            TileObjectData.addTile(TileType<RottenSapling>());
			

			ModTranslation name = CreateMapEntryName();
			name.SetDefault("Rotten Sapling");
